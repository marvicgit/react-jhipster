...
export const CommentUpdate = () => {
  ...
  const saveEntity = values => {
    ...
    const entity = {
      ...commentEntity,
      ...values,
      child: comments.find(it => it.id.toString() === values.child.toString()),
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          login: commentEntity?.login?.id,
          child: commentEntity?.child?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterApp.comment.home.createOrEditLabel" data-cy="CommentCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField id="comment-login" name="login" data-cy="login" label="Login" type="select">
                <option value="" key="0" />
                {users
              ...
              <ValidatedField id="comment-child" name="child" data-cy="child" label="Child" type="select">
                <option value="" key="0" />
                {comments
