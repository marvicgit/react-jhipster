          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Reported By <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {ticketList.map((ticket, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{ticket.date ? <TextFormat type="date" value={ticket.date} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{ticket.status}</td>
                  <td>{ticket.type}</td>
                  ...
                  <td>{ticket.reportedBy ? ticket.reportedBy.login : ''}</td>
